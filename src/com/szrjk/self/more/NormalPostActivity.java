...
public class NormalPostActivity extends BaseActivity {
	...
	private NormalPostActivity instance;
	@ViewInject(R.id.lv_normal_postlist)
	...
	protected void doGetMorePosts(String userId2, String basePostId,
		...
		busiParams.put("postType",Constant.NORMAL_POST);
		...
		DHttpService.httpPost(paramMap, new AbstractDhomeRequestCallBack() {
			...
			public void failure(HttpException exception, JSONObject jobj) {
				postListComm.operrefreshComplete();
				showToast(NormalPostActivity.this, "获取帖子失败，请检查网络", Toast.LENGTH_SHORT);
			}
		});
	}
