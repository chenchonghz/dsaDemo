...
public class RecommendContent {
	...
	public void setProps(List<CircleType> props) {
		this.props = props;
	}
	...
	public String toString() {
		return "RecommendContent [coterieDesc=" + coterieDesc
				+ ", coterieFaceUrl=" + coterieFaceUrl + ", coterieId="
				+ coterieId + ", coterieLevel=" + coterieLevel
				...
				+ ", deptName=" + deptName + ", professionalTitle="
				+ professionalTitle + ", userFaceUrl=" + userFaceUrl
