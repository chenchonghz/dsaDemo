...
public class PostSendPopup extends PopupWindow
{
	private TextView tv_save, tv_nsave, tv_cancel;
	private View mMenuView;

	public PostSendPopup(Activity context, OnClickListener itemsOnClick)
	{
		super(context);
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.popup_post_send, null);
		tv_save = (TextView) mMenuView.findViewById(R.id.tv_save);
