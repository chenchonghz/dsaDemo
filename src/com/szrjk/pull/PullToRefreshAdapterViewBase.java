...
import com.szrjk.pull.internal.EmptyViewMethodAccessor;
import com.szrjk.pull.internal.IndicatorLayout;
	...
	private boolean isFirstItemVisible()
	{
		...
		else
		{
			...
			if (mRefreshableView.getFirstVisiblePosition() <= 1)
			{
				...
				if (firstVisibleChild != null) { return firstVisibleChild
						.getTop() >= mRefreshableView.getTop(); }
			}
		}
	...
	private boolean isLastItemVisible()
	{
		...
		else
		{
			...
			if (lastVisiblePosition >= lastItemPosition - 1)
			{
				...
				if (lastVisibleChild != null) { return lastVisibleChild
