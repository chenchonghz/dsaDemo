...
/**
 * 疑难求助的消息界面,区别于CaseSharePostActivity
 */
...
public class CaseSharePostMessageActivity extends BaseActivity {
	...
	private void initActivityData() {
		...
		hv_caseshare.showImageLLy(R.drawable.icon_messageset_40,new OnClickListener() {
	...
	protected void doGetMorePosts(String userId2, String basePostId,
		...
		busiParams.put("basePostId", "0");//查询为0
		...
		DHttpService.httpPost(paramMap, new AbstractDhomeRequestCallBack() {
			...
			public void failure(HttpException exception, JSONObject jobj) {
				postListComm.operrefreshComplete();
				showToast(CaseSharePostMessageActivity.this, "获取帖子失败，请检查网络", Toast.LENGTH_SHORT);
			}
		});
	}
