...
//		postContentLayout.setPostDetail(postDetail);
	 ...
	 * @param context
	 */
	private void loadPostDetailedData(final String userSeqId, final String postId,
									  Context context)
	{
...
//						CaseDetail caseDetail1 = new CaseDetail();
						...
						// 下面会抛错 com.alibaba.fastjson.JSONException: exepct '[', but string, type : class com.szrjk.entity.OrdinaryPostDetail
//						OrdinaryPostDetail ordinaryPostDetail = JSON.parseObject(returnObj.getString("ListOut"),OrdinaryPostDetail.class);
						...
						if (listOut.getString("commentList") != null
							...
							ArrayList<Comment> commentList = (ArrayList<Comment>) JSON
									.parseArray(
											...
											Comment.class);
							//层次太深，抽出来
							com.alibaba.fastjson.JSONArray jsonCommentArray  = listOut.getJSONArray("commentList");
						...
						if (listOut.getJSONObject("postDetail") != null) {
							PostDetail ppostDetail = JSON.parseObject(listOut.getString("postDetail"), PostDetail.class);
							List<PostAbstractList> palist = JSON.parseArray(listOut.getJSONObject("postDetail").getString("postAbstractList"), PostAbstractList.class);
							...
							fowardPostContentLayout.setPostDetail(postAbstractInfo);
							fowardPostContentLayout.setUserCard(srcuc);
							fowardPostContentLayout.setBackgroundColor(getResources().getColor(R.color.bg_global));
						}
...
//						postDetail.setSrcIsDelete(listOut.getJSONObject("postDetail").getString("srcIsDelete"));
						...
						ordinaryPostDetail.setMineLike(listOut.getBooleanValue("isMineLike"));
						...
						/**底部的init处理**/
						postDetailBottomOperLayout.initData(postId, userSeqId, postText, faceurl, username, postType, new ICallback() {
							@Override
							public void doCallback(Map m) {
								...
								if(islike){
									...
									ToastUtils.showMessage(PostDetailFowardActivity2.this, "点赞成功!");
									loadPostDetailedData(userSeqId, postId, instance);
									...
									ToastUtils.showMessage(PostDetailFowardActivity2.this, "取消点赞成功!");
									loadPostDetailedData(userSeqId, postId, instance);
									postDetailBottomOperLayout.getBtn_laud().setClickable(false);
								}
