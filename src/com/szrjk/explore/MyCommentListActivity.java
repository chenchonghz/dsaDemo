                                ...
                                for (int i = 0; i < list.size(); i++) {
                                    ...
                                    if (object.getString("abstractInfo") != null
                                        ...
                                        PostInfo abstractInfo = JSON.parseObject(
                                                ...
                                                PostInfo.class);
                                        myPostComments.setAbstractInfo(abstractInfo);
                                    }
                                    if (object.getString("userCard_SecondLayer") != null && !object.getString("userCard_SecondLayer").isEmpty()) {
                                    ...
                                    if (object.getString("userCard_FirstLayer") != null
                                            && !object.getString("userCard_FirstLayer").isEmpty()) {
