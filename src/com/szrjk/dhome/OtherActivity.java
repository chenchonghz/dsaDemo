	...
	public void onClick(View v) {
		try {
			...
			case R.id.iv_identity:
						...
						new OnClickListener() {
							...
							public void onClick(View v) {
								...
								case R.id.tv_delete_image:
									...
									bt_identity.setTag("0");
									i_state = "no";
									System.err.println("删除了身份证图片" + i_state);
									chekcImageState();
				...
				pop_iden.showAtLocation(ll_other, Gravity.BOTTOM
			...
			case R.id.iv_workpermit:
				...
				pop_work.showAtLocation(ll_other, Gravity.BOTTOM
						| Gravity.CENTER_HORIZONTAL, 0, 0);
...
//		busiParams.put("listCertPicIn", l);
	 ...
	 * @param iv 要显示目标图片ID
	 */
	//	private void showPoPWindow(ImageView iv){
	//		menuWindow = new AddPhotoPopup(instance, casePhotoClick);
	//		// 显示窗口                                                     增加一个img，让返回的图片显示
	//		menuWindow.showAtLocation(iv, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
	//	}
