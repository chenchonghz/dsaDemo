...
public class CreatorManagePopup extends PopupWindow
{
	private TextView tv_invite, tv_delete, tv_dissolve, tv_cancel;
	private View mMenuView;

	public CreatorManagePopup(Activity context, OnClickListener itemsOnClick)
	{
		super(context);
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.popup_creator_manage, null);
		tv_invite = (TextView) mMenuView.findViewById(R.id.tv_invite);
		tv_delete = (TextView) mMenuView.findViewById(R.id.tv_delete);
		//tv_dissolve = (TextView) mMenuView.findViewById(R.id.tv_dissolve);
		...
		//tv_dissolve.setOnClickListener(itemsOnClick);
