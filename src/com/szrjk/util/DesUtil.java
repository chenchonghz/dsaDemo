...
//		return new DesUtil().strEnc(data, "g", "z", "sq");
		return Des3.encode(data);
	}
	 ...
	 * @return
	 */
	public static String deString(String data) {
		return new DesUtil().strDec(data, "g", "z", "sq");
	}
