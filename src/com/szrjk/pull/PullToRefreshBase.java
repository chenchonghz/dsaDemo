...
import com.szrjk.pull.internal.FlipLoadingLayout;
import com.szrjk.pull.internal.LoadingLayout;
import com.szrjk.pull.internal.RotateLoadingLayout;
import com.szrjk.pull.internal.Utils;
import com.szrjk.pull.internal.ViewCompat;
		...
		implements IPullToRefresh<T>
{
	...
	public final boolean onTouchEvent(MotionEvent event)
	{
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN
				&& event.getEdgeFlags() != 0) { return false; }
